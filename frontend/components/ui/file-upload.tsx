        ...
        (uploadingFile: File) => {
            ...
            uploadIntervalRef.current = setInterval(() => {
                ...
                if (currentProgress >= 100) {
                    ...
                    setProgress(0);
                    setStatus("idle");
                    // Keep the file to show the uploaded image
                    // setFile(null);
                    ...
                    >
                        ...
                        <div className="relative h-[240px]">
                            <AnimatePresence mode="wait">
                                {((existingImageUrl && existingImageUrl.trim() !== "" && !file && status === "idle") || (file && status === "idle")) ? (
                                    <motion.div
                                        key="existing-image"
                                    ...
                                    >
                                        ...
                                        <div className="text-center space-y-1.5 mb-4">
                                            <h3 className="text-sm font-semibold text-gray-900 dark:text-white">
                                                {file ? "Uploaded Image" : "Current Image"}
                                            </h3>
                                        ...
                                        <div className="flex gap-2 w-4/5">
                                            <button
                                                ...
                                                type="button"
                                                className="flex-1 flex items-center justify-center gap-2 rounded-lg bg-blue-100 dark:bg-blue-900/30 px-4 py-2.5 text-sm font-semibold text-blue-700 dark:text-blue-300 transition-all duration-200 hover:bg-blue-200 dark:hover:bg-blue-900/50"
                                            >
                                                Change Image
                                            </button>
                                            <button
                                ...
                                ) : (status === "idle" || status === "dragging") && !existingImageUrl ? (
                                    <motion.div
                                        key="dropzone"
                                    ...
                                    >
                                        ...
                                        <button
                                            type="button"
                                            onClick={triggerFileInput}
                                            className="w-4/5 flex  cursor-pointer  items-center justify-center gap-2 rounded-lg bg-gray-100 dark:bg-white/10 px-4 py-2.5 text-sm font-semibold text-gray-900 dark:text-white transition-all duration-200 hover:bg-gray-200 dark:hover:bg-white/20 group"
                                        >
